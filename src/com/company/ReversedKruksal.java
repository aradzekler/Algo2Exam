...
class Edge implements Comparable<Edge>{
	...
	public Edge(int vertex1, int vertex2, int weight){ // defining our Edge, 2 vertexes and its weight V1---W---V2
...
class ReverseDeleteMST {
	...
	//Breadth First Search - checking connectivity using BFS
